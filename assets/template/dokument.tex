...
% Zitate, Quotes, Cite
% Chicago Notes and Bibliography (Empfehlung des Leitfadens):
% Quellennachweise erscheinen als Fußnote, im Anhang folgt das alphabetisch
% sortierte Literaturverzeichnis. \autocite (durch \customcite gekapselt) setzt
% die Quelle automatisch in eine Fußnote.
\usepackage[notes,backend=biber,autocite=footnote,ibidtracker=false]{biblatex-chicago}
\addbibresource{bib/literatur.bib}  % Pfad zur Literaturdatenbank

% Sortierung im Literaturverzeichnis: Nachname, Vorname
\DeclareNameAlias{sortname}{family-given}
\DefineBibliographyStrings{german}{andothers = {{et\,al\adddot}},}
\usepackage{csquotes}

% Komfort-Befehl für Quellennachweise mit optionaler Seitenangabe.
% Verwendung: \customcite{schluessel} oder \customcite[S.~42]{schluessel}.
...
% Pflegen Sie die Reihenfolge und Anzahl der \input-Zeilen unten gemaess Ihrer
% projektspezifischen Gliederung. Das Template bleibt gleich, die Kapitelstruktur
% wird jedoch fuer jede Arbeit individuell festgelegt.
\cleardoublepage % Seitenumbruch erzwingen vor Änderung des Nummerierungsstils
