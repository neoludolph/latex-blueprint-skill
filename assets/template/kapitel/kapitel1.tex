...
\begin{enumerate}
    ...
    \item Kompilieren Sie das Dokument (typisch: \texttt{pdflatex} $\rightarrow$ \texttt{biber} $\rightarrow$ \texttt{pdflatex} $\rightarrow$ \texttt{pdflatex}).
\end{enumerate}
...
\begin{itemize}
    ...
    \item Beispielinhalte in Kapitel 2, inklusive Nutzwertanalyse sowie Mermaid-Quelltext mit passender LaTeX-Darstellung fuer Diagramme.
\end{itemize}
