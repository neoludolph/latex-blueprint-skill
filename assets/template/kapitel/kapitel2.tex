...
Das Literaturmanagement ist in der Vorlage gemaess Chicago Notes and Bibliography vorkonfiguriert. Quellennachweise erscheinen als Fussnote unmittelbar nach Zitat oder Paraphrase, im Anhang folgt das alphabetisch sortierte Literaturverzeichnis. Verwende dafuer den Befehl \verb|\customcite|, optional mit Seitenangabe als optionalem Argument.

Beispielzitate (jeweils als Fussnote):
\begin{itemize}
    \item Leitfaden zum wissenschaftlichen Schreiben mit LaTeX.\customcite{mustermann2023}
    \item Beispielartikel zur Vorlagenarbeit.\customcite[S.~12]{doe2024}
    \item Offizielle Projektseite von LaTeX.\customcite{latexproject}
\end{itemize}
